        ...
        <div id="comicdiv" class="postbox">
          ...
          <div class="inside" style="overflow: auto">
            ...
            <p>
              ...
              <a href="admin.php?page=<?php echo substr(realpath(dirname(__FILE__) . "/../comicpress_manager_admin.php"), strlen(ABSPATH . '/' . PLUGINDIR)) ?>&replace=<?php echo $comic_filename ?>"><?php _e('Replace this image with another', 'comicpress-manager') ?></a>.
            </p>
