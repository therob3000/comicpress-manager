...
As of version 1.0.1, it allows you to:
...
As of 0.9.8, ComicPress Manager's configuration is defined in the comicpress\_manager\_config.php file in the comicpress\_manager folder.
